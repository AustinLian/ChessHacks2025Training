...
# ---------- CONFIG: EDIT THESE ----------
# Your big PGN file:
PGN_PATH = Path(r"F:/VS Code Storage/ChessHacks2025/training\scripts/chunk_4.pgn")


# Where to save the dataset:
OUT_PATH = Path(r"training/data/processed/sf_supervised_dataset1000games3.npz")
